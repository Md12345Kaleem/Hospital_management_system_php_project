...
if($_SERVER ['REQUEST_METHOD']=="POST")
{
  ...
  $sql="INSERT INTO `nurselist` (`fname`, `lname`, `gender`, `nation`, `marital`, `religion`, `experiance`, `email`, `password`, `dob`, `pob`, `poi`, `doi`, `visa`, `tens`, `tenp`, `tenb`, `tws`, `twp`, `twb`, `colln`, `colltp`, `collp`, `cityn`, `distric`, `state`, `pin`, `number`) VALUES ('$fname', '$lname', '$gender', '$nation', '$marital', '$Religion', '$Experiance', '$Email', '$Password', '$Date_Birth', '$Place_Birth', '$Place_issue', '$Date_Issue', '$Visa', '$School_ten', '$tPercentage', '$Board', '$twSchool', '$twPercentage', '$twBoard', '$College_name', '$Total_percentage', '$Place_of_college', '$city_name', '$Distric_name', '$State_name', '$pin_code', '$Phone_no')";        
...
Nurse Details</h1></center><br>
          <form class="needs-validation bg-success" novalidate  action="Nurse_Entry.php" method="POST">
  <div class="form-row">
